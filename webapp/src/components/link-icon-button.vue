<template lang="pug">
router-link.bunt-icon-button(v-tooltip="tooltipOptions || {text: tooltip, placement: tooltipPlacement, fixed: tooltipFixed}", :to="to", :class="{disabled}", :aria-disabled="disabled", :aria-label="tooltip || iconClass()")
