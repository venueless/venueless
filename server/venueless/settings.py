...
ALLOW_HTTP_TO_PRIVATE_NETWORKS = config.getboolean("urls", "allow_http_to_private_networks", fallback=os.environ.get("VENUELESS_ALLOW_HTTP_TO_PRIVATE_NETWORKS", "").lower() == "true")
