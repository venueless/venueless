...
ROLES = [
    ...
    },
    {
        ...
        "permissions": {
            ...
            "invite_participant": False,
            "manage_breakout": False,
            "manage_broadcast": ["v-attendee", "v-speaker"],
            "manage_content_library": False,
            "manage_edit_whiteboard": ["v-attendee", "v-speaker"],
            "manage_personal_content_library": False,
            "manage_polls": False,
            "manage_roles": False,
            "manage_screenshare": ["v-attendee", "v-speaker"],
            "moderate_qa": False,
            "present_content_library": True,
            "present_files": True,
            "private_chat": True,
            "raise_hand": True,
            "recording": False,
            "remote_muting": ["v-attendee", "v-speaker"],
            "remove_participant": False,
            "screenshare": True,
            "see_participants_panel": True,
            "start_session": True,
