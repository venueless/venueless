...
class Permission(Enum):
    ...
    WORLD_ROOMS_CREATE_VIDEO = "world:rooms.create.bbb"
    ...
    ROOM_DIGITALSAMBA_JOIN = "room:digitalsamba.join"
    ROOM_DIGITALSAMBA_SPEAK = "room:digitalsamba.speak"
    ROOM_DIGITALSAMBA_MODERATE = "room:digitalsamba.moderate"
    ROOM_DIGITALSAMBA_RECORDINGS = "room:digitalsamba.recordings"
